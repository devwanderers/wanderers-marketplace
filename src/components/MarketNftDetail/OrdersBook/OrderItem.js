...
const OrderItem = (props) => {
    return (
        <span className="h-14 w-full mb-1 flex flex-row items-center cursor-pointer text-white bg-blue-11 hover:bg-blue-1 rounded-2xl transition ease-in-out duration-300">
